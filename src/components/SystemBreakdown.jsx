  ...
  const systems = [
    {
      ...
      description:
        "We craft irresistible offers that speak directly to your ideal client's deepest desires and objections.",
    ...
    },
    {
      ...
      description:
        'Strategic content that builds trust, demonstrates expertise, and attracts qualified leads automatically.',
    ...
    },
    {
      ...
      description:
        'High-converting landing pages and email sequences that turn visitors into booked calls.',
    ...
    },
    {
      ...
      description:
        'Proven scripts and frameworks that convert conversations into paying clients.',
    ...
    },
    {
      ...
      description:
        'Continuous testing and refinement to maximize your conversion rates and ROI.',
